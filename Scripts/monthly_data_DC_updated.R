...
# GLOBALS ----------------------------------------------------------------------
current_month<-"2024-05" # CHANGE EACH MONTH
current_month_full<-"2024-05-31" # CHANGE EACH MONTH
last_month<- "2024-04" #CHANGE EACH MONTH
current_mo_minus_3<- "2024-02" #CHANGE EACH MONTH
lastQmo<-"2024-03" #CHANGE TO BE LAST MONTH OF MOST RECENTLY REPORTED MER Q
...
#combine -----------------------------------------------------------------------
final_df<-df_current %>% 
  filter(mon_yr >"2023-11-31") %>% #reduce non-MER to last 6 mo only
  bind_rows(targets) %>% 
